 ...
 * the request data. Application and message specific deserializers must
 * implement {@link CustomRequestDeserializer CustomRequestDeserializer}
 * interface.
 *
